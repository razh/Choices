...
// CONCATENATED MODULE: ./assets/scripts/src/actions/index.js
var addItem = function addItem(value, label, id, choiceId, groupId, customProperties) {
  return {
    type: 'ADD_ITEM',
    value: value,
    label: label,
...
var actions_highlightItem = function highlightItem(id, highlighted) {
  return {
    type: 'HIGHLIGHT_ITEM',
    id: id,
...
var addChoice = function addChoice(value, label, id, groupId, disabled, elementId, customProperties) {
  return {
    type: 'ADD_CHOICE',
    value: value,
    label: label,
...
// CONCATENATED MODULE: ./assets/scripts/src/lib/utils.js
...
// CONCATENATED MODULE: ./assets/scripts/src/choices.js
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_fuse_js__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__store_index_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__lib_polyfills_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__lib_polyfills_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__lib_polyfills_js__);
...
var Choices = function () {
  function Choices() {
    ...
    // Create data store
    this.store = new __WEBPACK_IMPORTED_MODULE_2__store_index_js__["a" /* default */](this.render);
    ...
    var canInit = isElement(this.passedElement) && isValidType;
  ...
  _createClass(Choices, [{
    ...
    value: function highlightItem(item) {
      ...
      this.store.dispatch(actions_highlightItem(id, true));
    ...
    value: function unhighlightItem(item) {
      ...
      this.store.dispatch(actions_highlightItem(id, false));
      ...
      var onDirectionKey = function onDirectionKey() {
        ...
        if (hasActiveDropdown || passedElementType === 'select-one') {
          ...
          if (nextEl) {
            ...
            if (!isScrolledIntoView(nextEl, _this17.choiceList, directionInt)) {
    ...
    value: function _addChoice(value, label) {
      ...
      this.store.dispatch(addChoice(value, choiceLabel, choiceId, groupId, isDisabled, choiceElementId, customProperties));
    ...
    value: function _addGroup(group, id) {
      ...
      if (groupChoices) {
        ...
        groupChoices.forEach(function (option) {
          ...
          var label = isType('Object', option) ? option[labelKey] : option.innerHTML;
    ...
    value: function _createTemplates() {
      ...
      var templates = {
        ...
        itemList: function itemList() {
          ...
          var localClasses = __WEBPACK_IMPORTED_MODULE_1_classnames___default()(globalClasses.list, (_classNames = {}, _defineProperty(_classNames, globalClasses.listSingle, _this23.passedElement.type === 'select-one'), _defineProperty(_classNames, globalClasses.listItems, _this23.passedElement.type !== 'select-one'), _classNames));
        ...
        item: function item(data) {
          ...
          var localClasses = __WEBPACK_IMPORTED_MODULE_1_classnames___default()(globalClasses.item, (_classNames2 = {}, _defineProperty(_classNames2, globalClasses.highlightedState, data.highlighted), _defineProperty(_classNames2, globalClasses.itemSelectable, !data.highlighted), _classNames2));

          if (_this23.config.removeItemButton) {
            var _classNames3;

            localClasses = __WEBPACK_IMPORTED_MODULE_1_classnames___default()(globalClasses.item, (_classNames3 = {}, _defineProperty(_classNames3, globalClasses.highlightedState, data.highlighted), _defineProperty(_classNames3, globalClasses.itemSelectable, !data.disabled), _classNames3));
        ...
        choiceGroup: function choiceGroup(data) {
          var localClasses = __WEBPACK_IMPORTED_MODULE_1_classnames___default()(globalClasses.group, _defineProperty({}, globalClasses.itemDisabled, data.disabled));
        ...
        choice: function choice(data) {
          ...
          var localClasses = __WEBPACK_IMPORTED_MODULE_1_classnames___default()(globalClasses.item, globalClasses.itemChoice, (_classNames5 = {}, _defineProperty(_classNames5, globalClasses.itemDisabled, data.disabled), _defineProperty(_classNames5, globalClasses.itemSelectable, !data.disabled), _classNames5));

          return strToEl('\n          <div\n            class="' + localClasses + '"\n            data-select-text="' + _this23.config.itemSelectText + '"\n            data-choice\n            data-id="' + data.id + '"\n            data-value="' + data.value + '"\n            ' + (data.disabled ? 'data-choice-disabled aria-disabled="true"' : 'data-choice-selectable') + '\n            id="' + data.elementId + '"\n            ' + (data.groupId > 0 ? 'role="treeitem"' : 'role="option"') + '\n            >\n            ' + data.label + '\n          </div>\n        ');
        },
        input: function input() {
          var localClasses = __WEBPACK_IMPORTED_MODULE_1_classnames___default()(globalClasses.input, globalClasses.inputCloned);

          return strToEl('\n          <input\n            type="text"\n            class="' + localClasses + '"\n            autocomplete="off"\n            autocapitalize="off"\n            spellcheck="false"\n            role="textbox"\n            aria-autocomplete="list"\n            >\n        ');
        },
        dropdown: function dropdown() {
          var localClasses = __WEBPACK_IMPORTED_MODULE_1_classnames___default()(globalClasses.list, globalClasses.listDropdown);

          return strToEl('\n          <div\n            class="' + localClasses + '"\n            aria-expanded="false"\n            >\n          </div>\n        ');
        },
        notice: function notice(label) {
          var localClasses = __WEBPACK_IMPORTED_MODULE_1_classnames___default()(globalClasses.item, globalClasses.itemChoice);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__freeGlobal_js__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_symbol_observable__ = __webpack_require__(7);
...
// CONCATENATED MODULE: ./assets/scripts/src/reducers/items.js
function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }
...
/* harmony default export */ var items_defaultExport = (items);
// CONCATENATED MODULE: ./assets/scripts/src/reducers/groups.js
...
/* harmony default export */ var groups_defaultExport = (groups);
// CONCATENATED MODULE: ./assets/scripts/src/reducers/choices.js
...
/* harmony default export */ var choices_defaultExport = (choices);
// CONCATENATED MODULE: ./assets/scripts/src/reducers/index.js
...
var appReducer = combineReducers({
  items: items_defaultExport,
  groups: groups_defaultExport,
  choices: choices_defaultExport
});
...
/* harmony default export */ var reducers_defaultExport = (rootReducer);
// CONCATENATED MODULE: ./assets/scripts/src/store/index.js
...
var Store = function () {
  function Store() {
    ...
    this.store = createStore_createStore(reducers_defaultExport, window.devToolsExtension ? window.devToolsExtension() : undefined);
  }
